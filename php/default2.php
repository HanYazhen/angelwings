...
<head>
    ...
    <title><?php echo $_SESSION['un'] ?>---天使之翼</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="nav navbar-nav" style="margin-top: 0;">
                ...
                <li>
                    <a class="nav_head">
                        <img class="to_personal" src="../image/<?php echo $_SESSION['uid'] ?>/headimage/headimage.png"
                             width="50" height="50">
                        <div>
                            <span class="nav_head_name to_personal"><?php
                                echo $_SESSION['un'];
                                ?></span>
                            <span> ♂</span><br>
                            <span class="to_search to_personal">请设置学院</span>
                        </div>
                    </a>
                </li>
            </ul>
            ...
            <form method="post">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control fifty" maxlength="15" minlength="1" id="username"
                               required placeholder="请输入您的用户名">
                        <span id="username_ver"></span>
                    </div>
                    <div class="form-group">
                        <label for="password">密码</label><br>
                        <input type="password" class="form-control pass fifty" maxlength="20" minlength="4"
                               id="password" required placeholder="请输入您的密码">
                        <span id="pass_ver"></span>
                    </div>
                    <div class="form-group">
                        <label for="checkid">验证码</label><br>
                        <input name='authcode' required maxlength="4" minlength="4" type="text" class="form-control"
                               id="checkid" placeholder="请输入验证码">
                        <a href="#"
                           onclick="document.getElementById('captcha_img').src='./captcha.php?r='+Math.random()">看不清，换一个</a>
                        <img id="captcha_img" title="点击更换" src='captcha.php?r=echo rand();'
                             onclick="this.src='captcha.php?'+Math.random();">
                        <span id="checkid_ver"></span>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" data-target=".sign_up"
                            data-toggle="modal">转到注册页面
                    </button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
...
<!--注册-->
<div class="modal fade sign_up" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <!--<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <input type="email" class="form-control" placeholder="请输入绑定邮箱">
                    <input type="text" class="form-control" placeholder="请输入验证码">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" data-target=".sign_in"
                            data-toggle="modal">转到登录页面
                    </button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
